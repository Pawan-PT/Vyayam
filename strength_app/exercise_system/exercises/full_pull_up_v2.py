"""
Full Pull-Up - Dead hang to chin over bar, pronated grip
...
class FullPullUpV2:
    """Full Pull-Up - Level: intermediate | Pull pattern (bar track)

    Biomechanics:
    - Pronated grip (overhand); full dead hang to chin-over-bar
    - Scapular depression at initiation; elbow drive down and back
    - No kipping — strict form throughout
    - Full descent to dead hang required for rep to count
    ...
    def calculate_angles(self, analyzer, results, shape):
        """Elbow angle + chin clearance for pull-up rep counting."""
