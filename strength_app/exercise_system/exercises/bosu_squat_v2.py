"""
Bosu Squat - Squat on unstable BOSU ball surface.
...
class BosuSquatV2:
    """Bosu Squat. Level: building (L4). Target: quadriceps, glutes, ankle proprioception.

    Squat on unstable BOSU ball surface.
    """
