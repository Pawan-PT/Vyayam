"""
Shoulder Tap Push-Up - Push-up with alternating shoulder tap at top for anti-rotation challenge
...
class ShoulderTapPushUpV2:
    ...
    At top position, lift one hand and tap opposite shoulder; alternate sides.
    ...
    def calculate_angles(self, analyzer, results, shape):
        ...
        # Hip rotation during tap: y-difference of hips
    ...
    def validate_form(self, angles, phase):
        feedback = {}
        hip_rot = angles.get('hip_rot', 0)
        if phase == 'up' and hip_rot > 20:
            feedback['rotation'] = JointFeedback(
                joint='hip', status=FormStatus.WARNING,
                message="Keep hips square during the shoulder tap"
            )
        return feedback
