"""
Frog Stretch - Wide stance on all fours, sink hips back and down hold 45s.
...
class FrogStretchV2:
    """Frog Stretch. Level: foundation (L2) HOLD. Target: hip adductors, groin.

    Wide stance on all fours, sink hips back and down hold 45s.
    """
