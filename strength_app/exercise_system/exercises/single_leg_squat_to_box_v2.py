"""
Single Leg Squat to Box - Single-leg squat controlled descent to box. Drive back up sa
...
class SingleLegSquatToBoxV2:
    """Single Leg Squat to Box. Level: building (L4). Target: quadriceps, glutes, hip stabilisers."""
    ...
    def get_target_poses(self):
        return {'standing': {'avg_knee': 175, 'tolerance': 10},
                'descending': {'avg_knee': 130, 'tolerance': 15},
                'bottom': {'avg_knee': 105, 'tolerance': 15},
    ...
    def update_rep_counter(self, angle, feedback, voice):
        ...
        elif self.phase == "descending" and avg_knee < 115:
            self.phase = "bottom"
        elif self.phase == "bottom" and avg_knee > 130:
