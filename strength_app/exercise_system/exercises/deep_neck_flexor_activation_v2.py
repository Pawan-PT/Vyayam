"""
Deep Neck Flexor Activation - Supine gentle nod activating deep cervical flexors. No surface muscles.
...
class DeepNeckFlexorActivationV2:
    """Deep Neck Flexor Activation. Level: rehab (L1). Target: longus colli, longus capitis.

    Supine gentle nod activating deep cervical flexors. No surface muscles.
    """
