"""
Commando Pull-Up - Alternating side-to-side pull-up along the bar
...
class CommandoPullUpV2:
    ...
    Target: latissimus dorsi, biceps, obliques, rotational stability

    Head alternates sides of the bar each rep; chest leads on each side.
    """
    ...
    def update_rep_counter(self, angle, feedback, voice):
        ...
        # Alternate side every rep — tracked externally via active_side

        if self.phase == "hanging" and avg_elbow < 140:
            self.phase = "pulling"
            self.tempo_detector.start_phase('pulling')
        elif self.phase == "pulling" and avg_elbow < 50:
            self.phase = "top"
        elif self.phase == "top" and avg_elbow > 55:
            self.phase = "lowering"
