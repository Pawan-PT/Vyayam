"""
Drop Push-Up - Drop from elevated surface into push-up, absorb and explode up.
...
class DropPushUpV2:
    """Drop Push-Up. Level: advanced (L5). Category: power. Target: pectorals, anterior deltoid, reactive strength."""
    ...
    def __init__(self, target_reps=6):
        ...
        self.phase = "start"  # DA-EX-init: was 'elevated' — a phase the state machine never handles,
