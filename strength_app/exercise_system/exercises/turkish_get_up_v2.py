"""
Turkish Get-Up - Complex floor to standing movement with weight overhead.
...
class TurkishGetUpV2:
    """Turkish Get-Up. Level: advanced (L5). Category: rotate. Target: full body, shoulder stability, core."""
    ...
    def __init__(self, target_reps=3):
        ...
        self.phase = "start"  # DA-EX-init: was 'lying' — a phase the state machine never handles,
    ...
    def get_target_poses(self):
        return {phase:{'avg_knee':90,'tolerance':20} for phase in ['start', 'active', 'lying', 'elbow', 'hand', 'knee', 'standing']}
