"""
Hindu Squat - Flowing squat with heel rise and arm swing.
...
class HinduSquatV2:
    """Hindu Squat. Level: intermediate (L3). Target: quadriceps, calves, hip flexors."""
    ...
    def get_target_poses(self):
        return {'standing': {'avg_knee': 175, 'tolerance': 10},
                ...
                'bottom': {'avg_knee': 80, 'tolerance': 15},
    ...
    def update_rep_counter(self, angle, feedback, voice):
        ...
        elif self.phase == "descending" and avg_knee < 90:
            self.phase = "bottom"
