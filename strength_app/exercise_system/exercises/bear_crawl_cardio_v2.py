"""
Bear Crawl Cardio - Sustained bear crawl 60-90 seconds maintaining form under fatigue.
...
class BearCrawlCardioV2:
    """Bear Crawl Cardio. Level: foundation (L2). Category: cardio. Target: shoulders, core, hip flexors."""
