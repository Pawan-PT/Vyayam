"""
Close Grip Pull-Up - Pull-up with hands narrower than shoulder width
...
class CloseGripPullUpV2:
    ...
    Target: latissimus dorsi (inner), biceps brachii, brachialis

    Elbows travel closer to body vs. standard wide-grip; more bicep emphasis.
    """
    ...
    def get_target_poses(self):
        return {
            ...
            'pulling': {'avg_elbow': (30, 170), 'tolerance': 20},
            'top':     {'avg_elbow': 30,  'tolerance': 15},
    ...
    def update_rep_counter(self, angle, feedback, voice):
        ...
        elif self.phase == "pulling" and avg_elbow < 45:
            self.phase = "top"
        elif self.phase == "top" and avg_elbow > 50:
            self.phase = "lowering"
