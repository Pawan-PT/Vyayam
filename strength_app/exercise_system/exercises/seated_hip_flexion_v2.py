"""
Seated Hip Flexion - Seated lift knee toward chest for hip flexor activation.
...
class SeatedHipFlexionV2:
    """Seated Hip Flexion. Level: rehab (L1). Target: iliopsoas, rectus femoris.

    Seated lift knee toward chest for hip flexor activation.
    """
