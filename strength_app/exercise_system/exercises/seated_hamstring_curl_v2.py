"""
Seated Hamstring Curl - Seated curl heel toward chair under edge for hamstring activation.
...
class SeatedHamstringCurlV2:
    """Seated Hamstring Curl. Level: rehab (L1). Target: hamstrings.

    Seated curl heel toward chair under edge for hamstring activation.
    """
