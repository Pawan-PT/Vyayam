"""
Typewriter Push-Up - At bottom position, shift bodyweight side to side before pressing up
...
class TypewriterPushUpV2:
    ...
    Target: pectorals (unilateral emphasis), anterior deltoid, triceps

    At bottom, shift body to one side then the other before pressing back up.
    ...
    def calculate_angles(self, analyzer, results, shape):
        ...
        # Lateral shift: shoulder mid x relative to wrist mid x
        wrist_mid_x = (lw[0] + rw[0]) / 2
        shoulder_mid_x = (ls[0] + rs[0]) / 2
        lateral_shift = shoulder_mid_x - wrist_mid_x
