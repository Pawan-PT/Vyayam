"""
Crawl Drag - Bear crawl while dragging an object behind.
...
class CrawlDragV2:
    """Crawl Drag. Level: building (L4). Category: carry. Target: shoulders, core, hip flexors."""
    ...
    def __init__(self, target_reps=10):
        ...
        self.phase = "start"  # DA-EX-init: was 'crawling' — a phase the state machine never handles,
    ...
    def get_target_poses(self):
        return {phase:{'avg_knee':90,'tolerance':20} for phase in ['start', 'active', 'crawling']}
