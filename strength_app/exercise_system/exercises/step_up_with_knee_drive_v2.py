"""
Step Up with Knee Drive - Step up to box and drive opposite knee high at top.
...
class StepUpWithKneeDriveV2:
    """Step Up with Knee Drive. Level: intermediate (L3). Target: quadriceps, glutes, hip flexors."""
