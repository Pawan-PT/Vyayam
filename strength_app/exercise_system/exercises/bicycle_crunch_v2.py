"""
Bicycle Crunch - Supine alternating elbow to knee rotation exercise.
...
class BicycleCrunchV2:
    """Bicycle Crunch. Level: foundation (L2). Category: rotate. Target: obliques, rectus abdominis."""
    ...
    def get_target_poses(self):
        return {phase:{'avg_knee':90,'tolerance':20} for phase in ['start', 'active']}
