"""
Tempo Squat - Bodyweight squat 5-second eccentric descent.
...
class TempoSquatV2:
    """Tempo Squat. Level: intermediate (L3). Target: quadriceps, glutes (eccentric)."""
    ...
    def get_target_poses(self):
        return {'standing': {'avg_knee': 175, 'tolerance': 10},
                ...
                'bottom': {'avg_knee': 90, 'tolerance': 15},
    ...
    def update_rep_counter(self, angle, feedback, voice):
        ...
        if self.phase == 'descending' and self.descent_start_time:
        ...
        if self.phase == "standing" and avg_knee < 150:
            ...
            self.phase = "bottom"
        elif self.phase == "bottom" and avg_knee > 115:
