"""
Short Arc Quad - Supine towel under knee, extend knee through last 30 degrees.
...
class ShortArcQuadV2:
    """Short Arc Quad. Level: rehab (L1). Target: quadriceps (terminal extension).

    Supine towel under knee, extend knee through last 30 degrees.
    """
