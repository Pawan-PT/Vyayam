"""
Ring Row - Horizontal row on gymnastic rings
...
class RingRowV2:
    ...
    Target: latissimus dorsi, rhomboids, biceps, rotator cuff

    Rings allow natural wrist rotation; pull chest to rings with elbows back.
    """
