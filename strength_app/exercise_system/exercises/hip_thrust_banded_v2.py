"""
Hip Thrust Banded - Hip thrust with resistance band at knees for glute med activation.
...
class HipThrustBandedV2:
    """Hip Thrust Banded. Level: intermediate (L3). Target: gluteus maximus, gluteus medius."""
    ...
    def update_rep_counter(self, angle, feedback, voice):
        ...
        elif self.phase == "hinging" and avg_hip < 80:
            self.phase = "bottom"
        elif self.phase == "bottom" and avg_hip > 95:
