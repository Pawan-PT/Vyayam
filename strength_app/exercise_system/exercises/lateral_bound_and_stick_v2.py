"""
Lateral Bound and Stick - Lateral bound followed by 3-second stick landing each side.
...
class LateralBoundAndStickV2:
    """Lateral Bound and Stick. Level: advanced (L5). Category: power. Target: glutes, quads, ankle stabilisers."""
