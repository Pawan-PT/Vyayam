"""
Wall Angel - Back against wall slide arms up and down maintaining contact.
...
class WallAngelV2:
    """Wall Angel. Level: foundation (L1). Target: thoracic extensors, rotator cuff, scapular retractors.

    Back against wall slide arms up and down maintaining contact.
    """
