"""
Face Pull with Band - Band attached at head height, pull to face with external rotation
...
class FacePullBandV2:
    ...
    Target: rear deltoids, external rotators, rhomboids

    End position: hands beside ears, upper arms parallel to floor.
    """
    ...
    def update_rep_counter(self, angle, feedback, voice):
        ...
        elif self.phase == "pulling" and avg_elbow < 70:
            self.phase = "top"
