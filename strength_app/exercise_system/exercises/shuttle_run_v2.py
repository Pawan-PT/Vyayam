"""
Shuttle Run - Short distance back and forth sprints tracking deceleration mechanics.
...
class ShuttleRunV2:
    """Shuttle Run. Level: intermediate (L3). Category: cardio. Target: quadriceps, change of direction, cardiovascular."""
    ...
    def __init__(self, target_reps=8):
        ...
        self.phase = "start"  # DA-EX-init: was 'sprinting' — a phase the state machine never handles,
    ...
    def get_target_poses(self):
        return {phase:{'avg_knee':90,'tolerance':20} for phase in ['start', 'active', 'sprinting', 'decelerating', 'turning']}
