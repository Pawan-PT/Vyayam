"""
Single Leg Slider Curl - Sliding leg curl one leg at a time. Keep hips elevated throughout.
...
class SingleLegSliderCurlV2:
    """Single Leg Slider Curl. Level: advanced (L5). Target: hamstrings (eccentric+concentric)."""
    ...
    def get_target_poses(self):
        return {'standing':  {'avg_hip': 175, 'tolerance': 10},
                ...
                'bottom':    {'avg_hip': 75,  'tolerance': 15},
    ...
    def update_rep_counter(self, angle, feedback, voice):
        ...
        elif self.phase == "hinging" and avg_hip < 85:
            self.phase = "bottom"
        elif self.phase == "bottom" and avg_hip > 100:
