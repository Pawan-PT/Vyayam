"""
Seated Spinal Twist - Seated twist for thoracic mobility hold 30s each side.
...
class SeatedSpinalTwistV2:
    """Seated Spinal Twist. Level: foundation (L1) HOLD. Target: thoracic rotators, obliques.

    Seated twist for thoracic mobility hold 30s each side.
    """
