"""
Heel Drop - Stand on step edge lower heels slowly below step height.
...
class HeelDropV2:
    """Heel Drop. Level: rehab (L2) Achilles. Target: Achilles tendon, gastrocnemius, bone loading.

    Stand on step edge lower heels slowly below step height.
    """
