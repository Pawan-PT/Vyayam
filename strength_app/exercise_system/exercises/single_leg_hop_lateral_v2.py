"""
Single Leg Hop Lateral - Lateral hop on single leg sticking each landing.
...
class SingleLegHopLateralV2:
    """Single Leg Hop Lateral. Level: building (L4). Target: glutes, ankle stabilisers, balance.

    Lateral hop on single leg sticking each landing.
    """
