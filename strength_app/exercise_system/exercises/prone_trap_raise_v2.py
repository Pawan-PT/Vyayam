"""
Prone Trap Raise - Face down lift arms in T shape targeting lower trap.
...
class ProneTrapRaiseV2:
    """Prone Trap Raise. Level: rehab (L2) posture. Target: lower trapezius, middle trapezius.

    Face down lift arms in T shape targeting lower trap.
    """
