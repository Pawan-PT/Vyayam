"""
Jumping Rope Simulation - Jump rope movement without rope simulating arm and hop coordination.
...
class JumpingRopeSimulationV2:
    """Jumping Rope Simulation. Level: foundation (L2). Category: cardio. Target: calves, coordination, rhythm."""

    REFERENCE_VIDEO_URL = ""

    def __init__(self, target_reps=60):
        self.target_reps = target_reps
        self.rep_count = 0
        self.rejected_count = 0
        self.phase = "start"  # DA-EX-init: was 'hopping' — a phase the state machine never handles,
    ...
    def get_target_poses(self):
        return {phase:{'avg_knee':90,'tolerance':20} for phase in ['start', 'active', 'hopping']}
