"""
Sissy Squat - Lean back heels elevated knees travel far forward.
...
class SissySquatV2:
    """Sissy Squat. Level: building (L4). Target: quadriceps (extreme isolation)."""
    ...
    def get_target_poses(self):
        return {'standing': {'avg_knee': 175, 'tolerance': 10},
                ...
                'bottom': {'avg_knee': 60, 'tolerance': 15},
    ...
    def update_rep_counter(self, angle, feedback, voice):
        ...
        elif self.phase == "descending" and avg_knee < 70:
            self.phase = "bottom"
        elif self.phase == "bottom" and avg_knee > 85:
