"""
Isometric Quad Set - Seated tighten quad pressing back of knee to floor. 10s hold.
...
class IsometricQuadSetV2:
    """Isometric Quad Set. Level: rehab (L1). Target: vastus medialis oblique (VMO).

    Seated tighten quad pressing back of knee to floor. 10s hold.
    """
