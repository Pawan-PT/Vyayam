"""
B-Stance RDL - Staggered stance RDL — one foot offset as kickstand.
...
class BStanceRdlV2:
    """B-Stance RDL. Level: intermediate (L3). Target: hamstrings, glutes."""
    ...
    def get_target_poses(self):
        return {'standing':  {'avg_hip': 175, 'tolerance': 10},
                ...
                'bottom':    {'avg_hip': 90,  'tolerance': 15},
    ...
    def update_rep_counter(self, angle, feedback, voice):
        ...
        elif self.phase == "hinging" and avg_hip < 100:
            self.phase = "bottom"
