"""
Nordic Curl Weighted - Nordic hamstring curl holding weight at chest. Slower eccentric required.
...
class NordicCurlWeightedV2:
    """Nordic Curl Weighted. Level: advanced (L5). Target: hamstrings (eccentric)."""
