"""
Adductor Rock - Kneeling one leg extended, rock side to side.
...
class AdductorRockV2:
    """Adductor Rock. Level: foundation (L1). Target: hip adductors, inner thigh.

    Kneeling one leg extended, rock side to side.
    """
