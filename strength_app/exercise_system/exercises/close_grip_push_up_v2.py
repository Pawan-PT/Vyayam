"""
Close-Grip Push-Up - Diamond/close-hand position emphasising triceps
...
class CloseGripPushUpV2:
    """Close-Grip Push-Up - Level: intermediate | Push pattern

    Biomechanics:
    - Hands close together, index fingers/thumbs touching (diamond)
    - Elbows track along ribcage — tricep emphasis
    - Same full depth as standard push-up
    - Higher tricep brachii activation vs wide/standard grip
    ...
    def calculate_angles(self, analyzer, results, shape):
        """Elbow angle + elbow tuck (medial displacement of elbow from shoulder)."""
    ...
    def validate_form(self, angles, phase):
        ...
        if sa > 35:
            feedback['elbow_tuck'] = JointFeedback('elbow', FormStatus.WARNING,
                'Tuck elbows close to body — tricep focus')
        if ha < 160:
            feedback['hip'] = JointFeedback('hip', FormStatus.WARNING,
                'Maintain plank — no hip sag')
        return feedback
