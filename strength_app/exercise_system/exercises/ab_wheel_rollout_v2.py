"""
Ab Wheel Rollout - Kneeling rollout extending arms forward maintaining neutral spine.
...
class AbWheelRolloutV2:
    """Ab Wheel Rollout. Level: building (L4). Category: rotate. Target: rectus abdominis, hip flexors, serratus."""
    ...
    def get_target_poses(self):
        return {phase:{'avg_knee':90,'tolerance':20} for phase in ['start', 'active', 'extended', 'returning']}
