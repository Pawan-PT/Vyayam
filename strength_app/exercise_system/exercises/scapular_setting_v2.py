"""
Scapular Setting - Squeeze shoulder blades back and down hold 10s.
...
class ScapularSettingV2:
    """Scapular Setting. Level: rehab (L1). Target: lower trapezius, rhomboids.

    Squeeze shoulder blades back and down hold 10s.
    """
