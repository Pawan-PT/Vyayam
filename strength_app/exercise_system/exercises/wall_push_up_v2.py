"""
Wall Push-Up - Standing push-up variation against a wall
...
class WallPushUpV2:
    """Wall Push-Up - Level: foundation | Push pattern

    Biomechanics:
    - Hands on wall at shoulder height, body straight from head to heels
    - Elbows bend to ~90° at bottom, 45° angle from torso
    - Full extension at top without locking elbows
    - Reduced bodyweight load — ideal entry point for push pattern
    ...
    def calculate_angles(self, analyzer, results, shape):
        """Extract upper-body landmarks and compute elbow + shoulder angles."""
    ...
    def validate_form(self, angles, phase):
        ...
        if sa > 60:
            feedback['elbow_flare'] = JointFeedback('elbow', FormStatus.WARNING,
                'Keep elbows ~45° to your body')
        if phase == 'down' and ea < 70:
            feedback['depth'] = JointFeedback('elbow', FormStatus.GOOD,
                'Great depth — full range achieved')
        return feedback
