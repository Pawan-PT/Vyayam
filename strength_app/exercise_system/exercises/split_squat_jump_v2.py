"""
Split Squat Jump - Same leg remains front throughout; jump and land in same lunge stance.
...
class SplitSquatJumpV2:
    """Split Squat Jump. Level: building (L4). Category: power. Target: quadriceps, glutes, hip flexors."""
    ...
    def __init__(self, target_reps=8):
        ...
        self.phase = "start"  # DA-EX-init: was 'lunge' — a phase the state machine never handles,
    ...
    def get_target_poses(self):
        return {phase:{'avg_knee':90,'tolerance':20} for phase in ['start', 'active', 'lunge', 'airborne', 'landing']}
