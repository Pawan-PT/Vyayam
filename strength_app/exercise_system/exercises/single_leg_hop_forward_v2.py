...
class SingleLegHopForwardV2:
    ...
    def __init__(self, target_reps=10):
        ...
        self.phase = "start"  # DA-EX-init: was 'loading' — a phase the state machine never handles,
    ...
    def get_target_poses(self):
        return {phase:{'avg_knee':90,'tolerance':20} for phase in ['start', 'active', 'loading', 'airborne', 'landing']}
