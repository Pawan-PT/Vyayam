"""
Ankle Pumps - Point and flex ankle repeatedly for circulation and ROM.
...
class AnklePumpsV2:
    """Ankle Pumps. Level: rehab (L1). Target: tibialis anterior, gastrocnemius, circulation.

    Point and flex ankle repeatedly for circulation and ROM.
    """
