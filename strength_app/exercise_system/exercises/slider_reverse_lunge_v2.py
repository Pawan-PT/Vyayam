"""
Slider Reverse Lunge - Back foot on towel slides back into reverse lunge.
...
class SliderReverseLungeV2:
    """Slider Reverse Lunge. Level: intermediate (L3). Target: quadriceps, glutes, hip stabilisers."""
