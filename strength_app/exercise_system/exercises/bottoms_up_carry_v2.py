"""
Bottoms Up Carry - Kettlebell inverted bottom-up walk for grip and stability.
...
class BottomsUpCarryV2:
    """Bottoms Up Carry. Level: intermediate (L3). Category: carry. Target: grip, wrist stability, deltoids."""
    ...
    def __init__(self, target_reps=10):
        ...
        self.phase = "start"  # DA-EX-init: was 'walking' — a phase the state machine never handles,
