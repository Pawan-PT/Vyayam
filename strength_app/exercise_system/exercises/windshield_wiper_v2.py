"""
Windshield Wiper - Hanging from bar swing legs side to side.
...
class WindshieldWiperV2:
    """Windshield Wiper. Level: advanced (L4). Category: rotate. Target: obliques, lats, hip flexors."""
    ...
    def get_target_poses(self):
        return {phase:{'avg_knee':90,'tolerance':20} for phase in ['start', 'active', 'left', 'right']}
