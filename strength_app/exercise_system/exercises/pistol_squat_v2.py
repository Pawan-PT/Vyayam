"""
Pistol Squat - Full single-leg squat, other leg extended. Alternate sides p
...
class PistolSquatV2:
    """Pistol Squat. Level: advanced (L5). Target: quadriceps, glutes, balance."""
    ...
    def get_target_poses(self):
        return {'standing': {'avg_knee': 175, 'tolerance': 10},
                ...
                'bottom': {'avg_knee': 70, 'tolerance': 15},
    ...
    def update_rep_counter(self, angle, feedback, voice):
        ...
        elif self.phase == "descending" and avg_knee < 80:
            self.phase = "bottom"
        elif self.phase == "bottom" and avg_knee > 95:
