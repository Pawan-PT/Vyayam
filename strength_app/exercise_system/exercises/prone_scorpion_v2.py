"""
Prone Scorpion - Face down swing one leg over to opposite side for rotation.
...
class ProneScorpionV2:
    """Prone Scorpion. Level: foundation (L2). Target: thoracolumbar rotators, hip flexors.

    Face down swing one leg over to opposite side for rotation.
    """
