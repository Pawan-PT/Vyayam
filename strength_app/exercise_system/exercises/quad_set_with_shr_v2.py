"""
Quad Set with Straight Leg Raise - Quad set followed by straight leg raise knee locked throughout.
...
class QuadSetWithShrV2:
    """Quad Set with Straight Leg Raise. Level: rehab (L2) knee. Target: quadriceps, hip flexors.

    Quad set followed by straight leg raise knee locked throughout.
    """
