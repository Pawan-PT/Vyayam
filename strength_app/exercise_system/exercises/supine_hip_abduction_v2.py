"""
Supine Hip Abduction - Lying on back slide leg outward for abduction range.
...
class SupineHipAbductionV2:
    """Supine Hip Abduction. Level: rehab (L1). Target: gluteus medius, TFL.

    Lying on back slide leg outward for abduction range.
    """
