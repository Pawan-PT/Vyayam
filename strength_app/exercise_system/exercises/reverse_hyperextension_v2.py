"""
Reverse Hyperextension - Face down on surface, lift legs into hip extension.
...
class ReverseHyperextensionV2:
    """Reverse Hyperextension. Level: intermediate (L3). Target: gluteus maximus, hamstrings, spinal erectors."""
    ...
    def calculate_angles(self, analyzer, results, shape):
        ...
        return {'left_knee': left_knee, 'right_knee': right_knee, 'avg_knee': avg_knee,
                'avg_hip': avg_hip,
                'joints_coords': {'lh':lh,'lk':lk,'la':la,'rh':rh,'rk':rk,'ra':ra,'ls':ls,'rs':rs}}

    def get_target_poses(self):
        return {'standing':  {'avg_hip': 175, 'tolerance': 10},
