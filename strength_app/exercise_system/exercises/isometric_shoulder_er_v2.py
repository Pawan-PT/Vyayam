"""
Isometric Shoulder External Rotation - Elbow at side push against wall in external rotation 10s.
...
class IsometricShoulderErV2:
    """Isometric Shoulder External Rotation. Level: rehab (L1). Target: infraspinatus, teres minor.

    Elbow at side push against wall in external rotation 10s.
    """
