"""
Jumping Pull-Up - Jump to top position and control the negative phase
...
class JumpingPullUpV2:
    ...
    Target: latissimus dorsi, biceps, scapular retractors

    Jump gets chin over bar; focus on slow, controlled descent.
    """
