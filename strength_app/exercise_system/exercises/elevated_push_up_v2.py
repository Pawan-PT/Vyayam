"""
Elevated Push-Up - Hands on an elevated surface (between incline and floor height)
...
class ElevatedPushUpV2:
    ...
    Target: pectorals, anterior deltoid, triceps

    Hands elevated reduces load; suitable for building push-up strength.
    ...
    def validate_form(self, angles, phase):
        ...
        if phase == 'down' and elbow > 110:
            feedback['depth'] = JointFeedback(
                ...
                message="Lower further — full range of motion"
            )
        return feedback
