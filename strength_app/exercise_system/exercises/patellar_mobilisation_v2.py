"""
Patellar Mobilisation - Self-mobilise patella in all directions to restore glide.
...
class PatellarMobilisationV2:
    """Patellar Mobilisation. Level: rehab (L1) GUIDE. Target: patellofemoral joint.

    Self-mobilise patella in all directions to restore glide.
    """
