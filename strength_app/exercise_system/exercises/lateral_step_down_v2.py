"""
Lateral Step Down - Stand on step, lower opposite foot slowly to the side.
...
class LateralStepDownV2:
    """Lateral Step Down. Level: intermediate (L3) UNILATERAL. Target: quadriceps, hip stabilisers, VMO."""
    ...
    def get_target_poses(self):
        return {'standing':   {'front_knee': 170, 'tolerance': 10},
