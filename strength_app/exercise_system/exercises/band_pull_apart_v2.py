"""
Band Pull Apart - Standing, pull resistance band apart at chest height
...
class BandPullApartV2:
    ...
    Elbows stay extended throughout; squeeze shoulder blades at full pull.
    """
    ...
    def validate_form(self, angles, phase):
        ...
        if phase == 'top' and elbow < 150:
            feedback['elbows'] = JointFeedback(
                joint='elbow', status=FormStatus.WARNING,
                message="Keep arms straighter during the pull"
            )
        return feedback
    ...
    def update_rep_counter(self, angle, feedback, voice):
        ...
        elif self.phase == "pulling" and avg_elbow < 185:
            self.phase = "top"
        elif self.phase == "top" and avg_elbow > 190:
            self.phase = "lowering"
