"""
Squat Jump Turn - Jump squat with 180 degree turn landing controlled.
...
class SquatJumpTurnV2:
    """Squat Jump Turn. Level: advanced (L5). Category: power. Target: quadriceps, glutes, rotational power."""
    ...
    def __init__(self, target_reps=6):
        ...
        self.phase = "start"  # DA-EX-init: was 'loaded' — a phase the state machine never handles,
    ...
    def get_target_poses(self):
        return {phase:{'avg_knee':90,'tolerance':20} for phase in ['start', 'active', 'loaded', 'airborne', 'landing']}
